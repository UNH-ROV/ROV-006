...
const float magn_ellipsoid_center[3] = {122.134, -66.2648, 11.9398};
const float magn_ellipsoid_transform[3][3] = {{0.920885, 0.00656479, 0.00585159}, {0.00656479, 0.925146, 0.0227031}, {0.00585159, 0.0227031, 0.992331}};
// Gyroscope
